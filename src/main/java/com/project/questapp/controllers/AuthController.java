...
public class AuthController {
    ...
    private PasswordEncoder passwordEncoder; // creating password encoder
    ...
    public AuthResponse login(@RequestBody UserRequest loginRequest){
        ...
        // giving it to auth object to get authenticate
        SecurityContextHolder.getContext().setAuthentication(auth);
        // giving it to security context holder
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody UserRequest registerRequest){
        ...
        if(userService.getOneUserByUserName(registerRequest.getUserName()) != null){
            ...
            // if this user already in we should back a message and message like this user already in.
